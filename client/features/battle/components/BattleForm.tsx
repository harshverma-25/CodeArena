...
import { Swords, Plus, ShieldAlert, Timer, SlidersHorizontal, BookOpen } from "lucide-react";
          ...
          {DIFFICULTIES.map((d) => {
            ...
            return (
              <button
                ...
                className={`py-3 px-4 rounded-xl border text-sm font-bold uppercase tracking-wider transition-all duration-200 cursor-pointer ${
                  isActive
